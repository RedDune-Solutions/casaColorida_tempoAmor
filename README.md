...
| Ficheiro | O que é |
|---|---|
| `index.html` | Home — hero + widget de reserva, casas, lugares (Vila do Bispo), FAQ |
| `casa-colorida.html` / `tempo-amor.html` | Páginas de detalhe com galeria (lightbox em `casa.js`) |
| `booking.html` | Pedido de reserva — envia por **Web3Forms** + **hCaptcha**, sem pagamento online |
