...
(function () {
  var I18N = {
    pt: {
      ...
      'foot.credits': 'Fotos dos locais: Ana Rey, Auvideo, Monika Hoerath, manjerix e Elingunnur — via <a href="https://commons.wikimedia.org" target="_blank" rel="noopener noreferrer">Wikimedia Commons</a> (CC BY 3.0 · CC BY-SA 2.0/4.0)',
      ...
      /* páginas das casas */
      'page.title.ta': 'Tempo & Amor · Vila do Bispo',
      'page.title.cc': 'Casa Colorida · Vila do Bispo',
    ...
    en: {
      ...
      'foot.credits': 'Area photos: Ana Rey, Auvideo, Monika Hoerath, manjerix and Elingunnur — via <a href="https://commons.wikimedia.org" target="_blank" rel="noopener noreferrer">Wikimedia Commons</a> (CC BY 3.0 · CC BY-SA 2.0/4.0)',
